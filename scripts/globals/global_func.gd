...
func save_game():
	...
	var save_nodes = get_tree().get_nodes_in_group("BuildingsToSave")
...
func load_game():
	...
	while save_file.get_position() < save_file.get_length():
		...
		if node_data == null or typeof(node_data) != TYPE_DICTIONARY:
			print("Ungültige Save-Daten übersprungen:", json_string)
			continue
